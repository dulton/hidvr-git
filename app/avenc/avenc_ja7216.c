...
static void avenc_VideoPreProc(int nVeGrp, int nVeChn)
{
	...
	stPreProcConf.stClipAttr[0].stClipRect.s32Y = (stPreProcConf.stClipAttr[0].stClipRect.u32Height + 2) * (nVeChn % 8);
	...
	stPreProcConf.stClipAttr[0].u32ClipMode = (nVeChn < 8) ? VIDEO_FIELD_BOTTOM : VIDEO_FIELD_TOP;
