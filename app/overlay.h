...
extern SDK_ENC_VIDEO_OVERLAY_CANVAS_t* OVERLAY_create_canvas(size_t width, size_t height);
extern void OVERLAY_release_canvas(SDK_ENC_VIDEO_OVERLAY_CANVAS_t* canvas);

extern ssize_t OVERLAY_put_text(SDK_ENC_VIDEO_OVERLAY_CANVAS_t* canvas,
