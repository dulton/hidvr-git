...
// gpio0.6 for alarm out (to front panel)
// gpio0.7 for buzzer
//
...
// gpio5.0 not used
// gpio5.1 not used
// gpio5.2 for sensor 4 in
// gpio5.3 for sensor 2 in
// gpio5.4 not used
// gpio5.5 not used
// gpio5.6 not used
// gpio5.7 not used
...
static gpio_dev_t s_gpio_devs[] =
{
    ...
    {{5, 3,  GPIO_DIR_IN,  GPIO_PIN_LOW},  GPIO_SENSR},
    {{3, 6,  GPIO_DIR_IN,  GPIO_PIN_LOW},  GPIO_SENSR},
    {{5, 2,  GPIO_DIR_IN,  GPIO_PIN_LOW},  GPIO_SENSR},
};
...
int gpio_Platform_VerProbe(void)
{
    ...
    gpio_conf_t ProbeIO[] = {
        {5, 5,  GPIO_DIR_IN,  GPIO_PIN_HIGH},
        {5, 6,  GPIO_DIR_IN,  GPIO_PIN_HIGH},
    };
...
static void gpio_mode_conf(void)
{
	...
	reg_write32(IO_CONFIG_REG(20), 0x00000001); // 0:VI3DAT0;1:GPIO5_0.
	reg_write32(IO_CONFIG_REG(21), 0x00000001); // 0:VI3DAT1;1:GPIO5_1.
	reg_write32(IO_CONFIG_REG(22), 0x00000001); // 0:VI3DAT2;1:GPIO5_2.
	reg_write32(IO_CONFIG_REG(23), 0x00000001); // 0:VI3DAT3;1:GPIO5_3.
	reg_write32(IO_CONFIG_REG(24), 0x00000001); // 0:VI3DAT4;1:GPIO5_4.
	reg_write32(IO_CONFIG_REG(25), 0x00000001); // 0:VI3DAT5;1:GPIO5_5.
	reg_write32(IO_CONFIG_REG(26), 0x00000001); // 0:VI3DAT6;1:GPIO5_6.
	reg_write32(IO_CONFIG_REG(27), 0x00000001); // 0:VI3DAT7;1:GPIO5_7.
