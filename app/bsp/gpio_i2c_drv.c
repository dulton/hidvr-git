...
const unsigned long GPIOGRP[GPIO_I2C_NUM] = {0};
const unsigned long GPIOSCL[GPIO_I2C_NUM] = {1 << 1};
const unsigned long GPIOSDA[GPIO_I2C_NUM] = {1 << 0};
#elif defined(SDK_PLATFORM_HI3520)
#define GPIO_I2C_NUM (2)
const unsigned long GPIOGRP[GPIO_I2C_NUM] = {0, 3};
const unsigned long GPIOSCL[GPIO_I2C_NUM] = {1 << 1, 1 << 3};
const unsigned long GPIOSDA[GPIO_I2C_NUM] = {1 << 0, 1 << 1};
#elif defined(SDK_PLATFORM_HI3521)
#if   defined(_HI3515A_EXT) || defined(_HI3520D_EXT)
#define GPIO_I2C_NUM (1)
const unsigned long GPIOGRP[GPIO_I2C_NUM] = {1};
const unsigned long GPIOSCL[GPIO_I2C_NUM] = {1 << 7};
const unsigned long GPIOSDA[GPIO_I2C_NUM] = {1 << 6};
#else
#define GPIO_I2C_NUM (2)
const unsigned long GPIOGRP[GPIO_I2C_NUM] = {13, 10};
const unsigned long GPIOSCL[GPIO_I2C_NUM] = {1 << 3, 1 << 5};
const unsigned long GPIOSDA[GPIO_I2C_NUM] = {1 << 2, 1 << 6};
#endif
#elif defined(SDK_PLATFORM_HI3531)
#define GPIO_I2C_NUM (1)
const unsigned long GPIOGRP[GPIO_I2C_NUM] = {12};
const unsigned long GPIOSCL[GPIO_I2C_NUM] = {1 << 5};
const unsigned long GPIOSDA[GPIO_I2C_NUM] = {1 << 4};
#endif
...
static unsigned int i2c_data_read(int Grp)
{
    unsigned int tmpVal;
