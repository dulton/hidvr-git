...
h264_nal_unit_t *h264_print_nal_unit(h264_stream_t *s, h264_nal_unit_t *nu);
void h264_free_nal_unit(h264_nal_unit_t *nu);
...
int h264_f(h264_stream_t *s, uint32_t n, uint32_t pattern);
int32_t h264_se(h264_stream_t *s);
int h264_rbsp_trailing_bits(h264_stream_t *s);
