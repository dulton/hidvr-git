...
typedef struct HTTP_QUERY_PARA_LIST {
	...
	int (*add_int)(struct HTTP_QUERY_PARA_LIST *const thiz, HTTP_STR_t name, int val);
	int (*add_uint)(struct HTTP_QUERY_PARA_LIST *const thiz, HTTP_STR_t name, unsigned int val);
