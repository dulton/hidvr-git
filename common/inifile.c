...
/*=========================================================================
   WhichIniFile
  -------------------------------------------------------------------------
   Job : Check current opening ini filename
 *========================================================================*/
cchr*
WhichIniFile (void)
{
...
// 100723 law
/*=========================================================================
   ReadHex : Reads a hex format integer from the ini file
*========================================================================*/
unsigned int
ReadHex (cchr * Section, cchr * pKey, unsigned int Default)
{
	...
	sprintf(number, "%x%c", Default, '\0');
	str = (char*)ReadString(Section, pKey, number);
...
AddItemAt (struct ENTRY * EntryAt, char Mode, cchr * Text)
{
	...
	pNewEntry = (struct ENTRY *) malloc (sizeof (struct ENTRY));
	if (pNewEntry == NULL)
    {
		return FALSE;
    }
