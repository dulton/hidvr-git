...
#define FIRMWARE_MAGIC "JUAN HI3521 JA-R2116 FIRMWARE COPYRIGHT BY JUAN"
#define FIRMWARE_FILE_NAME_PREFIX "FWHJ2116_"
#else
#define FIRMWARE_MAGIC "JUAN HI3521 JA2116 FIRMWARE DESIGNED BY LAW"
#define FIRMWARE_FILE_NAME_PREFIX "FWHI2116_"
#endif

#define DEVICE_FEATURE_NO "132224"
