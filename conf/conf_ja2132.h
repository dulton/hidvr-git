...
#define MAX_DEC_CH (32)
#define MAX_PLAYBACK_CH (32)

#if defined(_EXT_JUANOEM)
#define FIRMWARE_MAGIC "JUAN HI3521 JA-R2132 FIRMWARE COPYRIGHT BY JUAN"
#define FIRMWARE_FILE_NAME_PREFIX "FWHJ2132_"
#else
#define FIRMWARE_MAGIC "JUAN HI3521 JA2132 FIRMWARE DESIGNED BY LAW"
#define FIRMWARE_FILE_NAME_PREFIX "FWHI2132_"
#endif

#define DEVICE_FEATURE_NO "151324"
