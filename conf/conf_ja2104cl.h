...
#define _HI3520D_RAM_LITE 1
#define _VGA_RESOLUTION_LITE 1
...
#define MAX_HDD_CNT (2)

#define MAX_TELECTRL_CH (4)

#define MAX_CIF_CNT (4)
#define MAX_D1_CNT (4)
#define MAX_EXT_LSIZE_CNT (2)
...
#define FIRMWARE_MAGIC "JUAN HI3515A JA-R2104CL FIRMWARE COPYRIGHT BY JUAN"
#define FIRMWARE_FILE_NAME_PREFIX "FWHJ2104CL_"
#else
#define FIRMWARE_MAGIC "JUAN HI3515A JA2104CL FIRMWARE DESIGNED BY LAW"
#define FIRMWARE_FILE_NAME_PREFIX "FWHI2104CL_"
#endif

#define DEVICE_FEATURE_NO "115115"
