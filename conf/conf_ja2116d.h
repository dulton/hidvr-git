...
#define FIRMWARE_MAGIC "JUAN HI3521 JA-R2116D FIRMWARE COPYRIGHT BY JUAN"
#define FIRMWARE_FILE_NAME_PREFIX "FWHJ2116D_"
#else
#define FIRMWARE_MAGIC "JUAN HI3521 JA2116D FIRMWARE DESIGNED BY LAW"
#define FIRMWARE_FILE_NAME_PREFIX "FWHI2116D_"
#endif

#define DEVICE_FEATURE_NO "131325"
