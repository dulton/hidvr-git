...
#define MIN_DEC_FPS (20)
#define MAX_DEC_RESOLUTION (1920*1080*2*30)

#define MAX_NETWORK_BANDWIDTH (20*1024)
...
#define VI_DEV_2MUX_CHNL
#if defined(_EXT_JUANOEM)
#define FIRMWARE_MAGIC "JUAN HI3520D JA-R2104HF FIRMWARE COPYRIGHT BY JUAN"
#define FIRMWARE_FILE_NAME_PREFIX "FWHJ2104HF_"
#else
#define FIRMWARE_MAGIC "JUAN HI3520D JA2104HF FIRMWARE DESIGNED BY LAW"
#define FIRMWARE_FILE_NAME_PREFIX "FWHI2104HF_"
#endif

#define DEVICE_FEATURE_NO "413221"
